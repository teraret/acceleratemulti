...
class AccountControllerSpec extends Specification implements ControllerUnitTest<AccountController>, DomainUnitTest<Account> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new Account(params)
        controller.save()
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.accountService = Mock(AccountService) {
            1 * save(_ as Account) >> { Account account ->
                throw new ValidationException("Invalid instance", account.errors)
            }
        }
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new Account(params)
        instance.id = 1
        instance.version = 0
